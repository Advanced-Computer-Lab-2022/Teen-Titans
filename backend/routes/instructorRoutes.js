...
const { createCourse, getCoursesTitles, allcourses, course, subject, instructorSearchCourse, changePassword, forgotPassword, resetPassword } = require('../controller/instructorController')
