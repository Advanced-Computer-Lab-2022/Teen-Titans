...
const { createExam,createCourse, getCoursesTitles, allcourses, course, subject, instructorSearchCourse ,editEmail,editBiography,definePromotion,createCourseExam} = require('../controller/instructorController')
