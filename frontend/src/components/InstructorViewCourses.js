        ...
        <div>
            ...
            <div className="container1">
                ...
                <input
                    ...
                    id='searchKey'
                    placeholder='search'
                    style={{ height: "50%", minWidth: 100, margin: "20px" }}
                    onChange={(e) => setSearchQuery(e.target.value)}
                />

                <FormControl style={{ minWidth: 100, marginTop: "12px" }} >
                    ...
                    <div className="trainee-courses" style={{ height: "10%", position: "absolute", top: "150px", left: "500px" }}>
                        {courseData && courseData.filter((course) =>
                            ...
                            <div className="display-courses" key={course.id}>
                                ...
                                <button className="display-courses-btn" onClick={() => window.location.href = `/Icourse?user=${user}&courseId=${course._id}&userId=${userId}`}>View Details</button>
